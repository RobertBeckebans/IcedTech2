...
{
	Com_Printf( "Checking user license...\n" );
	if( !FS_FileExists( "PAK0.PAK" ) )
	{
		Com_Error( ERR_FATAL, "Please copy PAK0.PAK from the retail version of Quake 1 into %s\n", BASEGAME );
	}

	if( !FS_FileExists( "PAK1.PAK" ) )
	{
		Com_Error( ERR_FATAL, "Please copy PAK1.PAK from the retail version of Quake 1 into %s\n", BASEGAME );
	}
}
