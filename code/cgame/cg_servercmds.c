...
#include "cg_local.h"
#include "../../baseq3/ui/menudef.h" // bk001205 - for Q3_ui as well
...
static void CG_ServerCommand( void )
{
	...
	if( !strcmp( cmd, "sound" ) )
	{
		...
		trap_S_StartSound( origin, ENTITYNUM_NONE, CHAN_BODY, cgs.gameSounds[ soundId ] );
	...
	if( !strcmp( cmd, "lsound" ) )
	{
		...
		trap_S_StartLocalSound( soundId, CHAN_BODY );
		return;
	}
