...
localEntity_t* CG_SmokePuff( const vec3_t p,
	...
	int                                   leFlags,
	qhandle_t                             hShader );
localEntity_t* CG_SmokePuffModel( const vec3_t p, const vec3_t vel, float radius, float r, float g, float b, float a, float duration, int startTime, int fadeInTime, int leFlags, qhandle_t hModel );
