...
void CG_PainEvent( centity_t* cent, int health )
{
	...
	{
		case 1:
			snd = "sound/player/pain1.wav";
			break;

		case 2:
			snd = "sound/player/pain2.wav";
			break;

		case 3:
			snd = "sound/player/pain3.wav";
			break;

		case 4:
			snd = "sound/player/pain4.wav";
			break;

		case 6:
		case 5:
			snd = "sound/player/pain5.wav";
			break;
	}
...
void CG_EntityEvent( centity_t* cent, vec3_t position )
{
	...
	switch( event )
	{
		...
		case EV_JUMP:
			DEBUGNAME( "EV_JUMP" );
			trap_S_StartSound( NULL, es->number, CHAN_VOICE, CG_CustomSound( es->number, "sound/player/plyrjmp8.wav" ) );
			break;
		case EV_TAUNT:
			DEBUGNAME( "EV_TAUNT" );
		...
		case EV_EXPLODE:
			FX_RocketExplosion( cent->lerpOrigin );
			break;

		case EV_DEBRIS_BIG:
			FX_SpawnWallDebrisBig( cent->lerpOrigin, es->origin2, es->eventParm );
			break;
		...
		case EV_DEBRIS:
			FX_SpawnWallDebris( es->origin, es->origin2, es->eventParm );
			break;
