...
void G_SpawnGEntityFromSpawnVars( void )
{
	...
	if( ( level.current_skill == 0 && ( ( int )ent->spawnflags & SPAWNFLAG_NOT_EASY ) ) || ( level.current_skill == 1 && ( ( int )ent->spawnflags & SPAWNFLAG_NOT_MEDIUM ) ) || ( level.current_skill >= 2 && ( ( int )ent->spawnflags & SPAWNFLAG_NOT_HARD ) ) )
	{
		G_FreeEntity( ent );
		return;
	}
...
void SP_worldspawn( void )
{
	...
	trap_SetConfigstring( CS_FOGENABLED, va( "%i", fogEnabled ) );
